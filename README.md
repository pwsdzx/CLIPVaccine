...
python CLIPVaccine_main.py --dataset CIFAR10 --network r18 --optimizer SGD --corruption_type Flip --corruption_ratio 0.45 --batch_size 128 --max_epoch 90 --classes 10 --estimator_interval 3 
...
python CLIPVaccine_main.py --dataset CIFAR100 --network r34 --optimizer SGD --corruption_type Flip --corruption_ratio 0.45 --batch_size 128 --max_epoch 200 --classes 100 --estimator_interval 3
```
